let skills = {
  Hero: {
    braveheart: {
      name_en: "Braveheart",
      name_jp: "ブレイブハート",
      desc: "For 3 turns, increases the chance of afterimage creation and all damages of afterimage. The damage boost is only active while Force Boost is active.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    miracleEdge: {
      ...
      name_jp: "ミラクルエッジ",
      desc: "Deals melee cut damage to all enemies, and restores HP to all party members. This can restores HP over maximum HP. The overhealed amount is removed at the end of turn.",
      stats: ["STR"],
      unique: true,
      type: "Break",
      dep: { braveheart: 0 },
    ...
    encouragement: {
      ...
      name_jp: "鼓舞",
      desc: "When the user attacks with a skill, restores HP to all party members. HP restored is based on user's maxHP. Does not activate for links, chases or counterattacks.",
      stats: [],
      dep: { },
      maxLevel: 8,
      coords: { x: 0, y: 3 }
    ...
    herosBonds: {
      ...
      name_jp: "勇者の絆",
      desc: "When all party members' HP is above a set precentage, increases user's attack and action speed.",
      stats: [],
      dep: { encouragement: 1 },
      maxLevel: 6,
      coords: { x: 1, y: 3 }
    ...
    clearMind: {
      name_en: "Clear Mind",
      name_jp: "心頭滅却",
      desc: "Removes binds and ailments and restores TP to the user. Cannot be used if user has no ailment or binds, and will not restores TP if they were cured prior to this skill being used.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 1, y: 5 }
    ...
    shadowCharge: {
      ...
      name_jp: "シャドウチャージ",
      desc: "Removes all afterimages. Until the end of next turn, increases user's attack and chance of creating afterimage. Number of afterimages consumed will not affect this skill's effect.",
      stats: [],
      dep: { mirageSword: 2 },
      maxLevel: 6,
      coords: { x: 2, y: 1 }
    ...
    shadowBenefit: {
      ...
      name_jp: "恵影",
      desc: "When the user uses a skill while an afterimage is present, refunds a precentage of the TP used for the skill to the user.",
      stats: [],
      dep: { shadowCharge: 2 },
      maxLevel: 8,
      coords: { x: 3, y: 1 }
    ...
    herosProof: {
      ...
      name_jp: "勇者の証",
      desc: "When all party members' HP is below a set precentage, increases user's defense and chance of being targetted.",
      stats: [],
      dep: { herosBonds: 2 },
      maxLevel: 6,
      coords: { x: 2, y: 3 }
    ...
    greatCourage: {
      ...
      name_jp: "大勇",
      desc: "When an ally whose HP is below a set precentage is attacked, the user has a chance to cover that ally. This skill will prioritize user's afterimage.",
      stats: [],
      dep: { herosProof: 1 },
      maxLevel: 8,
      coords: { x: 3, y: 3 }
    ...
    fervor: {
      name_en: "Fervor",
      name_jp: "気負い",
      desc: "Transfers binds and ailments on allies in user's row to the user, and restores Force to the user. If no binds or ailments are tranferred, Force will not increase.",
      stats: [],
      dep: { clearMind: 1 },
      maxLevel: 4,
      coords: { x: 2, y: 5 }
    ...
    thickShadow: {
      ...
      name_jp: "濃影",
      desc: "Afterimages have a chance of not disappearing at the end of turn.",
      stats: [],
      dep: { shadowBenefit: 3 },
      maxLevel: 10,
      coords: { x: 4, y: 1 }
    ...
    guardRush: {
      name_en: "Guard Rush",
      name_jp: "ガードラッシュ",
      desc: "Reduces all damage to all party members for one turn, and deal melee bash damage to one target at the end of turn. If the attack hits, this skill cannot be used again for a set number of turns. Damage is based on user's shield's DEF and number of activations of damage reduction. If no damage reduction took place, the attack will not happen.",
      stats: ["STR"],
      dep: { shieldMateria: 3 },
      maxLevel: 10,
      coords: { x: 4, y: 4 }
  ...
  Protector: {
    ...
    fortify: {
      name_en: "Fortify",
      name_jp: "渾身ディフェンス",
      desc: "Increases user's defense for a set number of turns.",
      stats: [],
      dep: { cellDivide: 2 },
      maxLevel: 8,
      coords: { x: 1, y: 2 }
    ...
    provoke: {
      name_en: "Provoke",
      name_jp: "挑発",
      desc: "Increases user's defense and chance of being targetted for a set number of turns.",
      stats: [],
      dep: { },
      maxLevel: 8,
      coords: { x: 0, y: 4 }
    ...
    healingWall: {
      ...
      name_jp: "ヒールウォール",
      desc: "When the user defends, restores HP to allies on user's row.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 0, y: 5 }
    ...
    recoveryGuard: {
      ...
      name_jp: "リカバリーガード",
      desc: "Removes binds for one row, and reduces physical damage to that row for one turn.",
      stats: [],
      dep: { backGuard: 1 },
      maxLevel: 4,
      coords: { x: 2, y: 1 }
    ...
    shieldRush: {
      name_en: "Shield Rush",
      name_jp: "シールドラッシュ",
      desc: "Deals melee bash damage to all enemies, and reduces their physical attack for 3 turns. Damage is based on user's shield's DEF.",
      stats: ["STR"],
      dep: { shieldSmite: 3 },
      maxLevel: 10,
      coords: { x: 2, y: 3 }
    ...
    keepGuard: {
      name_en: "Keep Guard",
      name_jp: "キープガード",
      desc: "Reduces all damage to one ally until the end of next turn, and disables all Guard skills until then.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 2, y: 4 }
    ...
    fireWall: {
      name_en: "Fire Wall",
      name_jp: "ファイアガード",
      desc: "Reduces one instance of fire damage to all party members. Higher level upgrades reduction to null, then absorb.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 3, y: 4 }
    ...
    iceWall: {
      name_en: "Ice Wall",
      name_jp: "フリーズガード",
      desc: "Reduces one instance of ice damage to all party members. Higher level upgrades reduction to null, then absorb.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 3, y: 5 }
    ...
    voltWall: {
      name_en: "Volt Wall",
      name_jp: "ショックガード",
      desc: "Reduces one instance of volt damage to all party members. Higher level upgrades reduction to null, then absorb.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 3, y: 6 }
    ...
    autoguard: {
      name_en: "Autoguard",
      name_jp: "オートガード",
      desc: "When the user is attacked, there is a chance to automatically reduces the damage.",
      stats: [],
      dep: { lineDivide: 3 },
      maxLevel: 10,
      coords: { x: 5, y: 2 }
    ...
    shieldFlare: {
      ...
      name_jp: "シールドフレア",
      desc: "Until the end of next turn, when the user is attacked, counterattacks with ranged fire damage. Damage is based on user's shield's DEF.",
      stats: ["STR"],
      dep: { shieldRush: 3 },
      maxLevel: 6,
      coords: { x: 4, y: 3 }
  ...
  Medic: {
    ...
    medicalMiracle: {
      ...
      name_jp: "超医術",
      desc: "Revives and removes ailment, binds and debuffs for all party members, and restores their HP.",
      stats: ["WIS"],
      unique: true,
      type: "Break",
      dep: { steadyHands: 0 },
    ...
    patchUp: {
      name_en: "Patch Up",
      name_jp: "戦後手当",
      desc: "Restores HP to all allies at the end of battle.",
      stats: ["WIS"],
      dep: { },
      maxLevel: 8,
      coords: { x: 0, y: 3 }
    ...
    antibodies: {
      name_en: "Antibodies",
      name_jp: "抗体",
      desc: "Increases rate of recovery from binds and ailment for the user.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 0, y: 4 }
    ...
    groupTherapy: {
      ...
      name_jp: "一斉救護",
      desc: "For a set number of turns, increases user`s healing skills` range, and decreases healing power and action speed.",
      stats: [],
      dep: { unbind: 1 },
      maxLevel: 8,
      coords: { x: 3, y: 3 }
    ...
    patrol: {
      name_en: "Patrol",
      name_jp: "警戒斥候",
      desc: "For a set amount of steps, nullify damage and muddy floors, and greatly reduces other sources of damage while exploring.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 2, y: 6 }
    ...
    chaseHeal: {
      name_en: "Chase Heal",
      name_jp: "チェイスヒール",
      desc: "For one turn, automatically restores HP to allies when they are attacked for a set amount of times. Every time this skill activates, its chance of activating decreases.",
      stats: ["WIS"],
      dep: { delayedHeal: 3 },
      maxLevel: 8,
      coords: { x: 4, y: 2 }
    ...
    overheal: {
      name_en: "Overheal",
      name_jp: "オーバーヒール",
      desc: "Medic skills in battle can restores HP over party members` maximum HP by a set precentage. The overhealed amount is removed at the end of turn.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 4, y: 3 }
  ...
  Survivalist: {
    ...
    mirageArrow: {
      ...
      name_jp: "ミラージュアロー",
      desc: "Deals ranged stab damage to one target. Decreases accuracy and action speed for 3 turns.",
      stats: ["STR"],
      unique: true,
      type: "Break",
      dep: { illusionStep: 0 },
    ...
    chainDance: {
      name_en: "Chain Dance",
      name_jp: "チェインダンス",
      desc: "For one turn, increases user`s evasion and chance of being targetted.",
      stats: [],
      dep: { blindArrow: 3 },
      maxLevel: 10,
      coords: { x: 1, y: 3 }
    ...
    finishingArrow: {
      ...
      name_jp: "仕留めの一矢",
      desc: "When the user attacks a target whose HP is below a set threshold, follow up with an attack with user`s weapon. Does not activate for Links, chases or counterattacks.",
      stats: ["STR"],
      dep: { flankShot: 3 },
      maxLevel: 8,
      coords: { x: 3, y: 1 }
    ...
    trickStep: {
      name_en: "Trick Step",
      name_jp: "トリックステップ",
      desc: "For a set number of turns, reduces accuracy of one row of enemies.",
      stats: [],
      dep: { chainDance: 2 },
      maxLevel: 10,
      coords: { x: 2, y: 3 }
    ...
    stalker: {
      name_en: "Stalker",
      name_jp: "警戒歩行",
      desc: "For a set amount of steps, reduces encounter rate.",
      stats: [],
    ...
    efficiency: {
      name_en: "Efficiency",
      name_jp: "エフィシエント",
      desc: "For 5 turns, increases HP restored by Medica and upgrades used by the user, and extends their range to one row.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 2, y: 5 }
    ...
    scapegoat: {
      name_en: "Scapegoat",
      name_jp: "スケープゴート",
      desc: "Selected ally will cover all party members a set amount of times this turn. Ineffective if that ally has leg bind.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 4, y: 5 }
    ...
    sneakAttack: {
      ...
      name_jp: "奇襲",
      desc: "For a set amount of steps, increases chance of preemptive attacks.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 4, y: 6 }
  ...
  Ronin: {
    peerless: {
      name_en: "Peerless",
      name_jp: "無双",
      desc: "For 3 turns, stance duration will not decrease, and stance cannot be removed. In addition, the user gains the effect of all stances.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    upperStance: {
      ...
      name_jp: "上段の構え",
	  desc: "Increases attack when Upper Stance is active, and increases duration of Upper Stance. At the start of each battle, the user automatically assumes the stance with the highest skill level.",
      stats: [],
      dep: { },
      maxLevel: 8,
      coords: { x: 0, y: 1 }
    ...
    clearStance: {
      ...
      name_jp: "青眼の構え",
	  desc: "Increases defense and Ronin skills' infliction rate when Clear Stance is active, and increases duration of Clear Stance. At the start of each battle, the user automatically assumes the stance with the highest skill level.",
      stats: [],
      dep: { },
      maxLevel: 8,
      coords: { x: 0, y: 2 }
    ...
    drawingStance: {
      ...
      name_jp: "居合の構え",
	  desc: "Increases accuracy, evasion and action speed when Drawing Stance is active, and increases duration of Drawing Stance. At the start of each battle, the user automatically assumes the stance with the highest skill level.",
      stats: [],
      dep: { },
      maxLevel: 8,
      coords: { x: 0, y: 3 }
    ...
    breath: {
      name_en: "Breath",
      name_jp: "息吹",
      desc: "Restores HP to user and allies adjacent to the user.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 1, y: 6 }
    ...
    helmSplitter: {
      ...
      name_jp: "兜割り ",
      desc: "Requires Stance. Deals melee cut damage to one target. Low accuracy, ignores cut resistance. Reduces stance duration by 2 after use. Critical hit if used during Upper Stance.",
      stats: ["STR"],
      dep: { upwardSlash: 1 },
      maxLevel: 10,
      coords: { x: 2, y: 1 }
    ...
    hazeSlash: {
      name_en: "Haze Slash",
      name_jp: "霞斬り",
      desc: "Requires Stance. Deals melee cut damage to one target. Attempts to inflict sleep. Reduces stance duration by 2 after use. Critical hit if used during Clear Stance.",
      stats: ["STR", "LUC"],
    ...
    horizontalSlice: {
      ...
      name_jp: "横一文字",
      desc: "Requires Stance. Deals melee cut damage to one row. Reduces stance duration by 2 after use. Critical hit if used during Drawing Stance.",
      stats: ["STR"],
      dep: { sheathStrike: 1 },
      maxLevel: 10,
      coords: { x: 2, y: 3 }
    ...
    swallowStrike: {
      ...
      name_jp: "ツバメがえし",
      desc: "Requires Stance. Deals multiple instances of melee cut damage to one target. Removes stance after use, and disables skills on the next turn. Critical hit if used during Upper Stance.",
      stats: ["STR"],
      dep: { flameGrater: 3 },
      maxLevel: 6,
      coords: { x: 4, y: 1 }
    ...
    bluntingStab: {
      ...
      name_jp: "鈍通し",
      desc: "Requires Stance. Deals melee stab damage to one target. Attempts to inflict petrify. Removes stance after use, and disables skills on the next turn. Critical hit if used during Clear Stance.",
      stats: ["STR", "LUC"],
      dep: { lightningStab: 3 },
      maxLevel: 6,
      coords: { x: 4, y: 2 }
    ...
    risingSpirit: {
      ...
      name_jp: "戦意高揚",
      desc: "At the end of turn, if a stance is active, restores TP to the user.",
      stats: [],
  ...
  "War Magus": {
    ...
    fairyRobe: {
      name_en: "Fairy Robe",
      name_jp: "大巫術：精霊衣",
      desc: "Removes ailment and binds for all party members, and restores their HP. This turn, negates all binds, ailments, stun, instant death and debuffs for all paty members.",
      stats: ["WIS"],
      unique: true,
      type: "Break",
      dep: { warEdgePower: 0 },
    ...
    strengthSlash: {
      ...
      name_jp: "巫剣：霊攻衰斬",
      desc: "Deals melee cut+almighty damage to one target. If target has an ailment, decreases their attack for 7 turns.",
      stats: ["STR"],
      dep: { randomDisease: 1 },
      maxLevel: 6,
      coords: { x: 1, y: 3 }
    ...
    guardSlash: {
      name_en: "Guard Slash",
      name_jp: "巫剣：霊防衰斬",
      desc: "Deals melee cut+almighty damage to one target. If target has an ailment, decreases their defense for 7 turns.",
      stats: ["STR"],
      dep: { randomDisease: 1 },
      maxLevel: 6,
      coords: { x: 1, y: 4 }
    ...
    vampire: {
      name_en: "Vampire",
      name_jp: "吸命",
      desc: "When the user deals damage to an enemy with ailment, restores HP to user's row. Can only activate once per turn.",
      stats: ["WIS"],
      dep: { },
      maxLevel: 6,
      coords: { x: 1, y: 5 }
    ...
    headcut: {
      name_en: "Headcut",
      name_jp: "巫剣：霊封頭斬",
      desc: "Deals melee cut+almighty damage to one target. If target has an ailment, attempts to inflict head bind.",
      stats: ["STR", "LUC"],
      dep: { strengthSlash: 2 },
      maxLevel: 8,
      coords: { x: 2, y: 3 }
    ...
    armcut: {
      name_en: "Armcut",
      name_jp: "巫剣：霊封腕斬",
      desc: "Deals melee cut+almighty damage to one target. If target has an ailment, attempts to inflict arm bind.",
      stats: ["STR", "LUC"],
      dep: { guardSlash: 2 },
      maxLevel: 8,
      coords: { x: 2, y: 4 }
    ...
    legcut: {
      name_en: "Legcut",
      name_jp: "巫剣：霊封脚斬",
      desc: "Deals melee cut+almighty damage to one target. If target has an ailment, attempts to inflict leg bind.",
      stats: ["STR", "LUC"],
    ...
    rouse: {
      name_en: "Rouse",
      name_jp: "奮起",
      desc: "Increases user's force gain based on the number of enemies with binds.",
      stats: [],
      dep: { vampire: 2 },
      maxLevel: 4,
      coords: { x: 2, y: 5 }
    ...
    barrier: {
      name_en: "Barrier",
      name_jp: "巫術：結界",
      desc: "For one turn, there is a chance to nullify binds, ailments and debuffs for all party members, up to a set number of times.",
      stats: [],
      dep: { warHealAll: 3 },
      maxLevel: 10,
      coords: { x: 5, y: 1.5 }
    ...
    ailingSlash: {
      ...
      name_jp: "巫剣：霊攻大斬",
      desc: "Deals melee cut+almighty damage to one target. If target has an ailment, increases damage dealt.",
      stats: ["STR"],
      dep: { legcut: 3 },
      maxLevel: 6,
      coords: { x: 4, y: 3.5 }
  ...
  Highlander: {
    heroBattle: {
      name_en: "Hero Battle",
      name_jp: "英雄の戦い",
      desc: "For 3 turns, spear skills will have increased power, and restore HP to all party members based on damage dealt. Spear skills that have activated instant death will still restores HP based on damage that would have been dealt.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    gaeBolg: {
      name_en: "Gae Bolg",
      name_jp: "ゲイボルグ",
      desc: "Deals ranged stab damage to all enemies, and restores TP to self based on damage dealt.",
      stats: ["STR"],
      unique: true,
      type: "Break",
      dep: { heroBattle: 0 },
    ...
    spearAssist: {
      ...
      name_jp: "スピアインボルブ",
      desc: "Deals melee stab damage to one target. If an elemental attack is used by an ally beforehand, adds that element to the attack and increases its damage. If more than one elemental attack were used, uses the element of the last elemental attack before Spear Assist's activation.",
      stats: ["STR"],
      dep: { longThrust: 2 },
      maxLevel: 10,
      coords: { x: 1, y: 1 }
    ...
    spiritShield: {
      ...
      name_jp: "不可視の霊盾",
      desc: "Consumes user's HP to increase elemental defense for one row for a set number of turns.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 1, y: 4 }
    ...
    bloodVeil: {
      name_en: "Blood Veil",
      name_jp: "ブラッドベール",
      desc: "When the user loses HP, increases defense until the end of turn.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 1, y: 5 }
    ...
    delayedCharge: {
      ...
      name_jp: "ディレイチャージ",
      desc: "Consumes user's HP to deal ranged stab damage to one target at the end of a set number of turns after. Damage is increased based on the number of turns passed before its activation. Ineffective if user dies before the skill activates.",
      stats: ["STR"],
      dep: { },
      maxLevel: 10,
      coords: { x: 3, y: 2 }
    ...
    bloodFortune: {
      ...
      name_jp: "グッドラック",
      desc: "Consumes all party member's HP to increase their infliction rates of binds and ailments for a set number of turns.",
      stats: [],
      dep: { spiritShield: 1 },
      maxLevel: 8,
      coords: { x: 2, y: 4 }
    ...
    alliedBonds: {
      ...
      name_jp: "絆の恩恵",
      desc: "If user's skill consumed HP of allies on user's row, restores their TP at the end of turn.",
      stats: [],
      dep: { legionCharge: 2 },
      maxLevel: 4,
      coords: { x: 5, y: 3 }
  ...
  Gunner: {
    ...
    coverFire: {
      name_en: "Cover Fire",
      name_jp: "後方支援",
      desc: "When user defends while in back row, restores HP to front row.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 0, y: 4 }
    ...
    shellShock: {
      name_en: "Shell Shock",
      name_jp: "後方撹乱",
      desc: "For one turn, reduces attack, defense, accuracy and evasion for enemies in back row, and attempts to inflict stun on them.",
      stats: ["LUC"],
      dep: { coverFire: 2 },
      maxLevel: 4,
      coords: { x: 1, y: 4 }
    ...
    actQuick: {
      name_en: "Act Quick",
      name_jp: "クイックアクト",
      desc: "Until the end of next turn, reduces TP usage and increases action speed.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 2, y: 3 }
    ...
    ricochet: {
      name_en: "Ricochet",
      name_jp: "跳弾",
      desc: "Deals multiple instances of ranged stab damage to random targets. Low accuracy. Higher level increases number of attacks.",
      stats: ["STR"],
      dep: { wildShot: 2 },
      maxLevel: 10,
      coords: { x: 4, y: 1 }
  ...
  Sovereign: {
    ...
    royalVeil: {
      name_en: "Royal Veil",
      name_jp: "ロイヤルベール",
      desc: "At the end of turn, if user's HP is full, restores HP to all party members. Only one instance of this skill can activate per turn.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 0, y: 5 }
    ...
    majesty: {
      name_en: "Majesty",
      name_jp: "王の威厳",
      desc: "Once per turn, when the user is damaged while having a buff active, restores HP to self.",
      stats: ["WIS"],
      dep: { },
      maxLevel: 6,
      coords: { x: 2, y: 0 }
    ...
    royalLineage: {
      ...
      name_jp: "王家の血統",
      desc: "When the user is buffed, restores TP to self. Does not activate if the buff negated a debuff.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 3, y: 0 }
  ...
  Ninja: {
    insolence: {
      name_en: "Insolence",
      name_jp: "不忍",
      desc: "For 3 turns, increases user's evasion and chance of being targetted.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    ninpoMirage: {
      ...
      name_jp: "忍法　陽炎",
      desc: "Creates a decoy of self in an empty slot. The decoy has added evasion and chance to be targetted.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 0, y: 5 }
    ...
    ninpoMastery: {
      ...
      name_jp: "忍びの心得",
      desc: "Increases attack. At max level, melee attacks will hit for full damage and can reach enemy back row, even when the user is in the back.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 1, y: 6 }
    ...
    ninpoFlight: {
      ...
      name_jp: "忍法　猿飛",
      desc: "This turn, user has a high chance of evading physical attacks. Each time the user evades an attack, the evasion boost is reduced.",
      stats: [],
      dep: { },
      maxLevel: 10,
      coords: { x: 3, y: 4 }
    ...
    statusAtkUp: {
      ...
      name_jp: "抑制攻撃ブースト",
      desc: "Increases chance of inflicting binds and ailments.",
      stats: [],
      dep: { },
      maxLevel: 8,
      coords: { x: 2, y: 6 }
    ...
    eyeForAnEye: {
      ...
      name_jp: "意趣返し",
      desc: "If the user has evaded an attack on the previous turn, increases chance of inflicting ailments",
      stats: [],
      dep: { ninpoShock: 2 },
      maxLevel: 6,
      coords: { x: 5, y: 1 }
    ...
    schadenfreude: {
      ...
      name_jp: "幸災楽禍",
      desc: "Deals melee cut damage to one target. Always hits. If target has an ailment, increases user's Force.",
      stats: ["STR"],
      dep: { hawkStrike: 2 },
      maxLevel: 8,
      coords: { x: 4, y: 2 }
    ...
    smokePowder: {
      ...
      name_jp: "煙の末",
      desc: "Reduces TP costs. Will not reduces cost to 0.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 4, y: 5 }
  ...
  Zodiac: {
    astrologersAxis: {
      ...
      name_jp: "占星時軸",
      desc: "For 3 turns, Zodiac attack skills will have increased power, and restores half of their TP cost to the user.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    restoreEther: {
      ...
      name_jp: "レストアエーテル",
      desc: "Increases attack based on number of TP spent on the previous turn. Does not activate if TP spent last turn is too low.",
      stats: [],
      dep: { focusEther: 2 },
      maxLevel: 6,
      coords: { x: 2, y: 4 }
    ...
    spreadEther: {
      ...
      name_jp: "多段式エーテル",
      desc: "Until the end of next turn, Zodiac attack skills will deal reduced damage, but hit 2-5 times to random targets. Meteor will instead hit 6-15 times.",
      stats: [],
      dep: { antiEther: 2 },
      maxLevel: 6,
      coords: { x: 4, y: 4 }
  ...
  Farmer: {
    ...
    finalTrick: {
      name_en: "Final Trick",
      name_jp: "最後の秘策",
      desc: "Fully restores all allies' force gauge, and any broken force gauges have a chance of be repaired.",
      stats: [],
      unique: true,
      type: "Break",
      dep: { itemAgain: 0 },
    ...
    earthsBounty: {
      ...
      name_jp: "大自然の恵み",
      desc: "Increases experience gain while user is alive.",
      stats: [],
      dep: { },
      maxLevel: 10,
      coords: { x: 1, y: 6 }
    ...
    sharingIsCaring: {
      ...
      name_jp: "御裾分け",
      desc: "Consumes user's TP to restore TP to other allies on the same row.",
      stats: [],
      dep: { },
      maxLevel: 8,
      coords: { x: 2, y: 5 }
    ...
    braveHeart: {
      name_en: "Brave Heart",
      name_jp: "怖いもの知らず",
      desc: "If the user is in front row and at full HP, restores TP at the end of turn.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 3, y: 5 }
    ...
    songOfLabour: {
      ...
      name_jp: "労作歌",
      desc: "During exploration, restores TP to all allies for every set number of steps taken.",
      stats: [],
      dep: { lullaby: 3 },
      maxLevel: 8,
      coords: { x: 5, y: 1.5 }
  ...
  Shogun: {
    ...
    sight: {
      name_en: "Sight",
      name_jp: "無明の極",
      desc: "Increases user's attack at night or when user is blinded.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 1, y: 4 }
    ...
    greatGeneral: {
      ...
      name_jp: "大武辺者",
      desc: "For 3 turns, increases physical attack and chance of being targetted for one ally.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 0, y: 5 }
    ...
    assassinGathering: {
      ...
      name_jp: "刺客寄せ",
      desc: "For a set number of steps, increases encounter rate and experience gain from defeating enemies.",
      stats: [],
      dep: { greatGeneral: 2 },
      maxLevel: 6,
      coords: { x: 1, y: 5 }
    ...
    bloodyLance: {
      ...
      name_jp: "血染めの朱槍",
      desc: "When the user kills an enemy or ally, increases user's attack.",
      stats: [],
      dep: { dusk: 2 },
      maxLevel: 6,
      coords: { x: 3, y: 4 }
    ...
    fellingBird: {
      ...
      name_jp: "飛鳥落とし",
      desc: "Increases damage dealt based on the number of attacks user had made on this turn.",
      stats: [],
      dep: { },
      maxLevel: 10,
      coords: { x: 2, y: 6 }
    ...
    reprisalCommand: {
      ...
      name_jp: "報復射撃陣",
      desc: "This turn, when selected row is attacked, all allies equipped with a bow or gun will counterattack with their bow or gun. Does not activate against counterattacks.",
      stats: ["STR"],
      dep: { blitzCommand: 3 },
      maxLevel: 6,
      coords: { x: 4, y: 2 }
    ...
    mercyKill: {
      name_en: "Mercy Kill",
      name_jp: "介錯",
      desc: "When any enemy or ally receives an attack, and their HP becomes below a set precentage, there is a chance to inflict instant death to them.",
      stats: [],
      dep: { curseStrike: 3 },
      maxLevel: 4,
      coords: { x: 5, y: 4 }
    ...
    foreHonor: {
      name_en: "Fore Honor",
      name_jp: "先陣の名誉",
      desc: "For 3 turns, increases physical attack and action speed and decreases physical defense for one ally.",
      stats: [],
      dep: { reincarnation: 2 },
      maxLevel: 6,
      coords: { x: 4, y: 5 }
  ...
  Landsknecht: {
    trinity: {
      name_en: "Trinity",
      name_jp: "三位一体",
      desc: "For 3 turns, increases user's attack, accuracy and action speed.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    fullCharge: {
      name_en: "Full Charge",
      name_jp: "フルチャージ",
      desc: "This turn, user is fully immune to any hostile effects from enemies. Until the end of next turn, increases user's attack and action speed.",
      stats: [],
      unique: true,
      type: "Break",
      dep: { trinity: 0 },
    ...
    sonicRaid: {
      name_en: "Sonic Raid",
      name_jp: "ソニックレイド",
      desc: "Deals melee damage to one target with user's weapon at the start of turn.",
      stats: ["STR"],
      dep: { },
      maxLevel: 8,
      coords: { x: 1, y: 1 }
    ...
    doubleStrike: {
      ...
      name_jp: "ダブルストライク",
      desc: "Deals 2 instances of melee damage to one target with user's weapon.",
      stats: ["STR"],
      dep: { sonicRaid: 2 },
      maxLevel: 8,
      coords: { x: 2, y: 1 }
    ...
    improvedLink: {
      ...
      name_jp: "リンクプラス",
      desc: "For 3 turns, increases the number of follow-ups that can be made from link skills used by the user, as well as chance of follow-up. Each action may trigger at most 4 link follow-ups.",
      stats: [],
    ...
    linkEnd: {
      name_en: "Link End",
      name_jp: "リンクエンド",
      desc: "Deals melee damage to one target with user's weapon. Damage is based on the number of link follow-ups made on the previous turn.",
      stats: ["STR"],
      dep: { linkMastery: 2 },
      maxLevel: 6,
      coords: { x: 5, y: 3 }
    ...
    fullBreak: {
      name_en: "Full Break",
      name_jp: "フルブレイク",
      desc: "Deals melee bash damage to one target. Damage is increased if the target has a Break skill debuff. Multiple Break debuffs will not increase damage further. Damage is based on user's shield's DEF.",
      stats: ["STR"],
      dep: { speedBreak: 2 },
      maxLevel: 6,
      coords: { x: 4, y: 5 }
  ...
  Nightseeker: {
    killerStance: {
      ...
      name_jp: "キラースタンス",
      desc: "For 3 turns, increases attack and ailment infliction chance for user.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    disaster: {
      name_en: "Disaster",
      name_jp: "ディザスター",
      desc: "Deals melee cut damage to one target. If target has an ailment, increases the ailment's duration.",
      stats: ["STR"],
      unique: true,
      type: "Break",
      dep: { killerStance: 0 },
    ...
    proficiency: {
      name_en: "Proficiency",
      name_jp: "夜賊の心得",
      desc: "Increases damage dealt to enemies with ailment.",
      stats: [],
      dep: { },
      maxLevel: 10,
      coords: { x: 1, y: 4 }
    ...
    decoySign: {
      name_en: "Decoy Sign",
      name_jp: "デコイサイン",
      desc: "For 3 turns, increases chance of being targetted for one ally.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 0, y: 5 }
    ...
    backstab: {
      name_en: "Backstab",
      name_jp: "バックスタブ",
      desc: "Deals melee cut damage to one target. Attempts to inflict head bind. If user has Shadow Cloak, add Almighty element to the attack and increases damage.",
      stats: ["STR", "LUC"],
      dep: { autoCloak: 2 },
      maxLevel: 10,
      coords: { x: 3, y: 3 }
    ...
    foulMastery: {
      ...
      name_jp: "闇討マスタリ",
      desc: "Increases attack every time user inflicts an ailment. Bonus stacks up to 3 times, and is reset if user dies.",
      stats: [],
      dep: { sneakAttack: 2 },
      maxLevel: 10,
      coords: { x: 3, y: 4 }
    ...
    spreadThrow: {
      ...
      name_jp: "スプレッドスロー",
      desc: "Until the end of next turn, increases throw skills' range to all targets, as well as their infliction rate.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 3, y: 6 }
  ...
  Arcanist: {
    circleProtection: {
      ...
      name_jp: "方陣護持",
      desc: "For 3 turns, increases user's binds and ailment infliction chance, and prevents circles from being removed.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    circleBoon: {
      name_en: "Circle Boon",
      name_jp: "陣回復",
      desc: "If a circle is active, restores HP to all party members at the end of turn.",
      stats: ["WIS"],
      dep: { },
      maxLevel: 4,
      coords: { x: 0, y: 1 }
    ...
    tpReturn: {
      name_en: "TP Return",
      name_jp: "ＴＰリターン",
      desc: "Restores TP to self when user inflicts a bind, ailment or stun. Inflicting something on multiple enemies will not increases the effect of this skill.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 4, y: 6 }
  ...
  Imperial: {
    ignition: {
      name_en: "Ignition",
      name_jp: "イグニッション",
      desc: "For 3 turns, user's drive skills will not activate overheat state.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    conversion: {
      name_en: "Conversion",
      name_jp: "コンバージョン",
      desc: "Restores TP to user. This can restore TP over maximum TP. The overhealed TP will disappear at the end of battle, or when user dies.",
      stats: [],
      unique: true,
      type: "Break",
      dep: { ignition: 0 },
    ...
    assaultDrive: {
      ...
      name_jp: "アサルトドライブ",
      desc: "Deals melee cut damage to one target, and places the user in overheat state for 7 turns. Cannot be used during overheat state. Low action speed, and the user will take double damage until the skill activates.",
      stats: ["STR"],
      dep: { },
      maxLevel: 10,
      coords: { x: 0, y: 4 }
    ...
    heatSink: {
      name_en: "Heat Sink",
      name_jp: "強制排熱",
      desc: "Reduces overheat duration by a set number of turns. Can only be used if overheat state is active.",
      stats: [],
      dep: { assaultDrive: 3 },
      maxLevel: 8,
      coords: { x: 1, y: 3.5 }
    ...
    overheatGuard: {
      ...
      name_jp: "過熱の守り",
      desc: "If overheat state is active, increases user's defense.",
      stats: [],
      dep: { assaultDrive: 3 },
      maxLevel: 6,
      coords: { x: 1, y: 4.5 }
    ...
    coolEdge: {
      name_en: "Cool Edge",
      name_jp: "クールエッジ",
      desc: "Connecting skill. Deals melee cut damage to one target. Reduces duration of overheat by 2 turns. Can only be used if an activation skill is used on the previous turn.",
      stats: ["STR"],
      dep: { massiveEdge: 2 },
      maxLevel: 4,
      coords: { x: 3, y: 1 }
    ...
    intercooler: {
      name_en: "Intercooler",
      name_jp: "インタークーラー",
      desc: "Increases the damage of Drive skills. Increasing this skill's level will also reduces the duration of overheat state.",
      stats: [],
    ...
    flameDrive: {
      name_en: "Flame Drive",
      name_jp: "フレイムドライブ",
      desc: "Deals melee cut+fire damage to one target, and places the user in overheat state for 8 turns. Cannot be used during overheat state. Low action speed, and the user will take double damage until the skill activates.",
      stats: ["STR"],
      dep: { intercooler: 3 },
      maxLevel: 8,
      coords: { x: 3, y: 3 }
    ...
    freezeDrive: {
      ...
      name_jp: "フリーズドライブ",
      desc: "Deals melee cut+ice damage to one target, and places the user in overheat state for 8 turns. Cannot be used during overheat state. Low action speed, and the user will take double damage until the skill activates.",
      stats: ["STR"],
      dep: { intercooler: 3 },
      maxLevel: 8,
      coords: { x: 3, y: 4 }
    ...
    shockDrive: {
      name_en: "Shock Drive",
      name_jp: "ショックドライブ",
      desc: "Deals melee cut+volt damage to one target, and places the user in overheat state for 8 turns. Cannot be used during overheat state. Low action speed, and the user will take double damage until the skill activates.",
      stats: ["STR"],
      dep: { intercooler: 3 },
      maxLevel: 8,
      coords: { x: 3, y: 5 }
    ...
    chargeEdge: {
      name_en: "Charge Edge",
      name_jp: "チャージエッジ",
      desc: "Terminating skill. Deals melee cut damage to one target. Until the end of next turn, increases user's attack. Can only be used if an activation skill or connecting skill is used on the previous turn.",
      stats: ["STR"],
      dep: { coolEdge: 2 },
      maxLevel: 6,
      coords: { x: 4, y: 1 }
    ...
    forceEdge: {
      name_en: "Force Edge",
      name_jp: "フォースエッジ",
      desc: "Terminating skill. Deals melee cut damage to one target. Restores Force to the user. Can only be used if an activation skill or connecting skill is used on the previous turn.",
      stats: ["STR"],
      dep: { impulseEdge: 2 },
      maxLevel: 6,
      coords: { x: 4, y: 2 }
    ...
    accelDrive: {
      name_en: "Accel Drive",
      name_jp: "アクセルドライブ",
      desc: "Deals melee cut+almighty damage to one target, and places the user in overheat state for 9 turns. Cannot be used during overheat state. Low action speed, and the user will take double damage until the skill activates.",
      stats: ["STR"],
      weapon: ["Drive Blade"],
      bodyParts: ["Arms"],
  ...
  Pugilist: {
    sealRush: {
      name_en: "Seal Rush",
      name_jp: "シールラッシュ",
      desc: "For 3 turns, increases user's bind infliction chance, and chases any of user's attacks on an enemy with binds, ailment or sun. Multi-hit attacks will only be chased once.",
      stats: [],
      unique: true,
      type: "Boost",
      dep: { },
    ...
    doublePunch: {
      ...
      name_jp: "ダブルパンチ",
      desc: "When any single-action, single-target Cestus skill is used, or when Corkscrew is used via Added Blow, or when Cross Counter is used (despite what the description claims), if they fail to inflict their bind or ailment, there is a chance the skill will be repeated.",
      stats: [],
      dep: { },
      maxLevel: 10,
      coords: { x: 0, y: 5 }
    ...
    fightingSpirit: {
      ...
      name_jp: "闘魂",
      desc: "If the user has lost HP on the previous turn, increases attack.",
      stats: [],
      dep: { devilsFist: 3 },
      maxLevel: 6,
      coords: { x: 3, y: 1 }
    ...
    leadingBlow: {
      ...
      name_jp: "リードブロー",
      desc: "Deals melee bash damage to one target. For every bind the target has, follow up with the corresponding Pugilist skill. For any ailment the target has, follow up with Corkscrew.",
      stats: ["STR"],
      dep: { addedBlow: 2 },
      maxLevel: 10,
      coords: { x: 3, y: 2.75 }
    ...
    breather: {
      name_en: "Breather",
      name_jp: "インターバル",
      desc: "Removes binds and ailment from the user, and increases attack until the end of next turn. Cannot be used if user has no binds or ailment.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 2, y: 4 }
    ...
    ragingWaves: {
      ...
      name_jp: "怒涛",
      desc: "Increases damage dealt based on the number of binds and ailment target has.",
      stats: [],
      dep: { meditation: 2 },
      maxLevel: 10,
      coords: { x: 5, y: 4.5 }
  ...
  Harbinger: {
    ...
    miasmaTorrent: {
      ...
      name_jp: "瘴気の激流",
      desc: "This turn, greatly reduces all enemies' attack, defense, evasion, action speed, and binds and ailment resistance.",
      unique: true,
      type: "Break",
      stats: [],
    ...
    miasmaArmor: {
      ...
      name_jp: "瘴気の兵装",
      desc: "Puts the user in Miasma Armor state for 3 turns. Increases action speed when Miasma Armor is active. At the start of battle, automatically puts the user in Miasma Armor state.",
      stats: [],
      dep: { },
      maxLevel: 4,
      coords: { x: 0, y: 4.5 }
    ...
    wiltingMiasma: {
      ...
      name_jp: "虚弱の瘴気",
      desc: "For a set number of turns, decreases all enemies' resistance and rate of recovery to ailments.",
      stats: [],
      dep: { slowingMiasma: 3 },
      maxLevel: 10,
      coords: { x: 2, y: 1.5 }
    ...
    arrestingMiasma: {
      ...
      name_jp: "縛弱の瘴気",
      desc: "For a set number of turns, decreases all enemies' resistance and rate of recovery to binds.",
      stats: [],
      dep: { wiltingMiasma: 3 },
      maxLevel: 10,
      coords: { x: 3, y: 1.5 }
    ...
    blackWave: {
      name_en: "Black Wave",
      name_jp: "黒き波動",
      desc: "At the end of turn, if Miasma Armor is active, restores TP to the user.",
      stats: [],
      dep: { soulTransfer: 1 },
      maxLevel: 4,
      coords: { x: 3, y: 5 }
    ...
    spiritAbsorb: {
      ...
      name_jp: "生気吸収",
      desc: "When the user uses a debuff skill, restores HP to the user. This restoration can heal beyond maximum HP. Overhealed HP will disappear at the end of turn.",
      stats: [],
      dep: { },
      maxLevel: 6,
      coords: { x: 2, y: 6 }
    ...
    miasmaWall: {
      name_en: "Miasma Wall",
      name_jp: "瘴気の防壁",
      desc: "Requires Miasma Armor. Removes Miasma Armor to attempt to nullify binds and ailments for all party members, up to a set amount of times.",
      stats: [],
      dep: { blackWave: 1 },
      maxLevel: 6,
      coords: { x: 4, y: 4.5 }
    ...
    soulFixation: {
      ...
      name_jp: "霊魂固着",
      desc: "Requires Miasma Armor. Removes Miasma Armor to attempt to nullify instant death, stun and debuffs for all party members, up to a set amount of times.",
      stats: [],
      dep: { blackWave: 1 },
      maxLevel: 6,
      coords: { x: 4, y: 5.5 }
    ...
    residualMiasma: {
      ...
      name_jp: "瘴気残留",
      desc: "Skills which remove Miasma Armor will instead reduces its duration by a set number of turns. If Miasma Armor's duration becomes 0 or less, it is removed.",
      stats: [],
